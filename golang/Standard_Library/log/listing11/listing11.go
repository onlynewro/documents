...
func init() {
	...
	Info = log.New(os.Stdout, "정보: ", log.Ldate|log.Ltime|log.Lshortfile)
	Warning = log.New(os.Stdout, "경보: ", log.Ldate|log.Ltime|log.Lshortfile)
	Error = log.New(io.MultiWriter(file, os.Stderr), "에러: ", log.Ldate|log.Ltime|log.Lshortfile)
}
