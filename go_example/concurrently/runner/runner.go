// runner 패키지는 프로세스의 실행 및 수명주기를 관리한다.package main
package runner
...
// 그리고 운영체제의 인터럽트에 의해 실행이 종료된다.
type Runner struct {
	// 운영체제로부터 전달되는 인터럽트 신호를 수신하기 위한 채널
...
var ErrTimeout = errors.New("운영체제 인터럽트 신호를 수신했습니다.")
